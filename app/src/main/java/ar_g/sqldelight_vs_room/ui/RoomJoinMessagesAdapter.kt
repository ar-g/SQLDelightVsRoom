...
//import ar_g.sqldelight_vs_room.room.MessageWithMedia
//
//class RoomJoinMessagesAdapter : PagedListAdapter<MessageWithMedia, MessageViewHolder>(object : DiffUtil.ItemCallback<MessageWithMedia>() {
